...
#photo=PhotoImage(file='E:\\restaurant\\Images\\coffeee.png')
...
bt2=Button(yy,text='Submit',font=('courier',15,'bold'),bg='whitesmoke',activebackground='green',command=coffe_order)
