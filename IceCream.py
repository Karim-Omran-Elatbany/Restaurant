...
c11=Checkbutton(yy, text='Passionfruit',onvalue='Fish Sandwich',offvalue=NULL,variable=var11)
...
c12=Checkbutton(yy, text='Oreos',onvalue='Fish Sandwich',offvalue=NULL,variable=var12)
...
c13=Checkbutton(yy, text='Sprinkles ',onvalue='Fish Sandwich',offvalue=NULL,variable=var13)
...
c14=Checkbutton(yy, text='Sea Salt',onvalue='Fish Sandwich',offvalue=NULL,variable=var14)
