...
c11=Checkbutton(yy, text='SUPER MELTS',variable=var11)
...
c12=Checkbutton(yy, text='Grilled Shrimp',variable=var12)
...
c13=Checkbutton(yy, text='Greek Salad',variable=var13)
...
c14=Checkbutton(yy, text='Fish Sandwich',variable=var14)
...
bt2=Button(yy,text='Submit',font=('courier',15,'bold'),bg='whitesmoke',activebackground='green',command=order)
