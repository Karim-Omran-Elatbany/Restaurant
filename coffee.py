...
var13=StringVar()
var14=StringVar()
c1=Checkbutton(yy, text='Cappuccino',onvalue='Cappuccino',offvalue=NULL,variable=var1)
c1.deselect()
c1.place(x=10,y=20)
...
c2=Checkbutton(yy, text='Short Machinator',onvalue='Short Machinator',offvalue=NULL,variable=var2)
c2.deselect()
c2.place(x=10,y=50)
...
c3=Checkbutton(yy, text='Long Machinator',onvalue='Long Machinator',offvalue=NULL,variable=var3)
c3.deselect()
c3.place(x=10,y=80)
...
c4=Checkbutton(yy, text='Affogato',onvalue='Affogato',offvalue=NULL,variable=var4)
c4.deselect()
c4.place(x=10,y=110)
...
c5=Checkbutton(yy, text='Piccolo Latte',onvalue='Piccolo Latte',offvalue=NULL,variable=var5)
c5.deselect()
c5.place(x=10,y=140)
...
c6=Checkbutton(yy, text='Flavoured Latte',onvalue='Flavoured Latte',offvalue=NULL,variable=var6)
c6.deselect()
c6.place(x=10,y=170)
...
c7=Checkbutton(yy, text='Latte',onvalue='Latte',offvalue=NULL,variable=var7)
c7.deselect()
c7.place(x=10,y=200)
...
c8=Checkbutton(yy, text='Espresso',onvalue='Espresso',offvalue=NULL,variable=var8)
c8.deselect()
c8.place(x=10,y=230)
...
c9=Checkbutton(yy, text='Flat White',onvalue='Flat White',offvalue=NULL,variable=var9)
c9.deselect()
c9.place(x=10,y=260)
...
c10=Checkbutton(yy, text='Long Black',onvalue='Long Black',offvalue=NULL,variable=var10)
c10.deselect()
...
c11=Checkbutton(yy, text='Bean Bar Latte',onvalue='Bean Bar Latte',offvalue=NULL,variable=var11)
c11.deselect()
...
c12=Checkbutton(yy, text='Hot Chocolate',onvalue='Hot Chocolate',offvalue=NULL,variable=var12)
c12.deselect()
...
c13=Checkbutton(yy, text='Snow Hot Chocolate',onvalue='Snow Hot Chocolate',offvalue=NULL,variable=var13)
c13.deselect()
...
c14=Checkbutton(yy, text='Choc Mocha',onvalue='Choc Mocha',offvalue=NULL,variable=var14)
c14.deselect()
