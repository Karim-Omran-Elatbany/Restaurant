...
photo=PhotoImage(file='D:\AMR\python project\\New folder\\Restaurant\\Images\\ss.png')
...
c11=Checkbutton(yy, text='Spices',variable=var11)
...
c12=Checkbutton(yy, text='Coca powder',variable=var12)
...
c13=Checkbutton(yy, text='Vanilla',variable=var13)
...
c14=Checkbutton(yy, text='almond',variable=var14)
...
def submit():
    yy.destroy()
    import result
bt2=Button(yy,text='Submit',font=('courier',15,'bold'),bg='whitesmoke',activebackground='green',command=soda_order)
